...
static const ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    // GGML_TYPE_I8
    { "i8",   1, 0, sizeof(int8_t),  false, nullptr, nullptr },
    // GGML_TYPE_I16
    { "i16",  1, 0, sizeof(int16_t), false, nullptr, nullptr },
    // GGML_TYPE_I32
    { "i32",  1, 0, sizeof(int32_t), false, nullptr, nullptr },
    // GGML_TYPE_I64
    { "i64",  1, 0, sizeof(int64_t), false, nullptr, nullptr },
    // GGML_TYPE_F64
    { "f64",  1, 0, sizeof(double),  false, nullptr, nullptr },
    // GGML_TYPE_F32
    { "f32",  1, 0, sizeof(float),   false, nullptr, nullptr },
    // GGML_TYPE_F16
    { "f16",  1, 0, sizeof(ggml_fp16_t), false,
         (ggml_to_float_t) ggml_fp16_to_fp32_row,
         (ggml_from_float_t) ggml_fp32_to_fp16_row },
    // GGML_TYPE_Q4_0
    { "q4_0", QK4_0, 0, sizeof(block_q4_0), true,
         (ggml_to_float_t) dequantize_row_q4_0,
         (ggml_from_float_t) quantize_row_q4_0_ref },
    // GGML_TYPE_Q4_1
    { "q4_1", QK4_1, 0, sizeof(block_q4_1), true,
         (ggml_to_float_t) dequantize_row_q4_1,
         (ggml_from_float_t) quantize_row_q4_1_ref },
    // GGML_TYPE_Q4_2 (deprecated)
    { "DEPRECATED", 0, 0, 0, false, nullptr, nullptr },
    // GGML_TYPE_Q4_3 (deprecated)
    { "DEPRECATED", 0, 0, 0, false, nullptr, nullptr },
    // GGML_TYPE_Q5_0
    { "q5_0", QK5_0, 0, sizeof(block_q5_0), true,
         (ggml_to_float_t) dequantize_row_q5_0,
         (ggml_from_float_t) quantize_row_q5_0_ref },
    // GGML_TYPE_Q5_1
    { "q5_1", QK5_1, 0, sizeof(block_q5_1), true,
         (ggml_to_float_t) dequantize_row_q5_1,
         (ggml_from_float_t) quantize_row_q5_1_ref },
    // GGML_TYPE_Q8_0
    { "q8_0", QK8_0, 0, sizeof(block_q8_0), true,
         (ggml_to_float_t) dequantize_row_q8_0,
         (ggml_from_float_t) quantize_row_q8_0_ref },
    // GGML_TYPE_Q8_1
    { "q8_1", QK8_1, 0, sizeof(block_q8_1), true,
         nullptr,
         (ggml_from_float_t) quantize_row_q8_1_ref },
    // GGML_TYPE_Q2_K
    { "q2_K", QK_K,  0, sizeof(block_q2_K), true,
         (ggml_to_float_t) dequantize_row_q2_K,
         (ggml_from_float_t) quantize_row_q2_K_ref },
    // GGML_TYPE_Q3_K
    { "q3_K", QK_K,  0, sizeof(block_q3_K), true,
         (ggml_to_float_t) dequantize_row_q3_K,
         (ggml_from_float_t) quantize_row_q3_K_ref },
    // GGML_TYPE_Q4_K
    { "q4_K", QK_K,  0, sizeof(block_q4_K), true,
         (ggml_to_float_t) dequantize_row_q4_K,
         (ggml_from_float_t) quantize_row_q4_K_ref },
    // GGML_TYPE_Q5_K
    { "q5_K", QK_K,  0, sizeof(block_q5_K), true,
         (ggml_to_float_t) dequantize_row_q5_K,
         (ggml_from_float_t) quantize_row_q5_K_ref },
    // GGML_TYPE_Q6_K
    { "q6_K", QK_K,  0, sizeof(block_q6_K), true,
         (ggml_to_float_t) dequantize_row_q6_K,
         (ggml_from_float_t) quantize_row_q6_K_ref },
    // GGML_TYPE_IQ2_XXS
    { "iq2_xxs", QK_K, 0, sizeof(block_iq2_xxs), true,
         (ggml_to_float_t) dequantize_row_iq2_xxs,
         nullptr },
    // GGML_TYPE_IQ2_XS
    { "iq2_xs", QK_K, 0, sizeof(block_iq2_xs), true,
         (ggml_to_float_t) dequantize_row_iq2_xs,
         nullptr },
    // GGML_TYPE_IQ3_XXS
    { "iq3_xxs", QK_K, 0, sizeof(block_iq3_xxs), true,
         (ggml_to_float_t) dequantize_row_iq3_xxs,
         (ggml_from_float_t) quantize_row_iq3_xxs_ref },
    // GGML_TYPE_IQ3_S
    { "iq3_s", QK_K, 0, sizeof(block_iq3_s), true,
         (ggml_to_float_t) dequantize_row_iq3_s,
         (ggml_from_float_t) quantize_row_iq3_s_ref },
    // GGML_TYPE_IQ2_S
    { "iq2_s", QK_K, 0, sizeof(block_iq2_s), true,
         (ggml_to_float_t) dequantize_row_iq2_s,
         (ggml_from_float_t) quantize_row_iq2_s_ref },
    // GGML_TYPE_IQ1_S
    { "iq1_s", QK_K, 0, sizeof(block_iq1_s), true,
         (ggml_to_float_t) dequantize_row_iq1_s,
         nullptr },
    // GGML_TYPE_IQ1_M
    { "iq1_m", QK_K, 0, sizeof(block_iq1_m), true,
         (ggml_to_float_t) dequantize_row_iq1_m,
         nullptr },
    // GGML_TYPE_IQ4_NL
    { "iq4_nl", QK4_NL, 0, sizeof(block_iq4_nl), true,
         (ggml_to_float_t) dequantize_row_iq4_nl,
         (ggml_from_float_t) quantize_row_iq4_nl_ref },
    // GGML_TYPE_IQ4_XS
    { "iq4_xs", QK_K,  0, sizeof(block_iq4_xs), true,
         (ggml_to_float_t) dequantize_row_iq4_xs,
         (ggml_from_float_t) quantize_row_iq4_xs_ref },
    // GGML_TYPE_Q8_K
    { "q8_K", QK_K,  0, sizeof(block_q8_K), true,
         nullptr, nullptr },
    // GGML_TYPE_BF16
    { "bf16", 1,    0, sizeof(ggml_bf16_t), false,
         (ggml_to_float_t) ggml_bf16_to_fp32_row,
         (ggml_from_float_t) ggml_fp32_to_bf16_row_ref },
    // GGML_TYPE_Q4_0_4_4
    { "TYPE_Q4_0_4_4 REMOVED, use Q4_0 with runtime repacking", 0, 0, 0, false,
         nullptr, nullptr },
    // GGML_TYPE_Q4_0_4_8
    { "TYPE_Q4_0_4_8 REMOVED, use Q4_0 with runtime repacking", 0, 0, 0, false,
         nullptr, nullptr },
    // GGML_TYPE_Q4_0_8_8
    { "TYPE_Q4_0_8_8 REMOVED, use Q4_0 with runtime repacking", 0, 0, 0, false,
         nullptr, nullptr },
    // GGML_TYPE_TQ1_0
    { "tq1_0", QK_K, 0, sizeof(block_tq1_0), true,
         (ggml_to_float_t) dequantize_row_tq1_0,
         (ggml_from_float_t) quantize_row_tq1_0_ref },
    // GGML_TYPE_TQ2_0
    { "tq2_0", QK_K, 0, sizeof(block_tq2_0), true,
         (ggml_to_float_t) dequantize_row_tq2_0,
         (ggml_from_float_t) quantize_row_tq2_0_ref },
    // GGML_TYPE_IQ4_NL_4_4
    { "TYPE_IQ4_NL_4_4 REMOVED, use IQ4_NL with runtime repacking", 0, 0, 0, false,
         nullptr, nullptr },
    // GGML_TYPE_IQ4_NL_4_8
    { "TYPE_IQ4_NL_4_8 REMOVED, use IQ4_NL with runtime repacking", 0, 0, 0, false,
         nullptr, nullptr },
    // GGML_TYPE_IQ4_NL_8_8
    { "TYPE_IQ4_NL_8_8 REMOVED, use IQ4_NL with runtime repacking", 0, 0, 0, false,
         nullptr, nullptr },
};
...
struct ggml_context * ggml_init(struct ggml_init_params params) {
    ...
    struct ggml_context * ctx = (ggml_context*)GGML_MALLOC(sizeof(struct ggml_context));
...
struct ggml_cgraph * ggml_new_graph_custom(struct ggml_context * ctx, size_t size, bool grads) {
    ...
    struct ggml_tensor ** grads_ptr     = grads ? (ggml_tensor**)incr_ptr_aligned(&p, hash_size * sizeof(struct ggml_tensor *), sizeof(struct ggml_tensor *)) : NULL;
    struct ggml_tensor ** grad_accs_ptr = grads ? (ggml_tensor**)incr_ptr_aligned(&p, hash_size * sizeof(struct ggml_tensor *), sizeof(struct ggml_tensor *)) : NULL;
